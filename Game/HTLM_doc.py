...
if __name__ == '__main__':
    ...
    new_body = Body()
    new_body.add_tag('a1', 'Aggregation')
    ...
    new_body.add_tag('p', "The composition object doesn't actually own the objects that it's composed of"
                          " - if it's destroyed, tose objects continue to exist")
